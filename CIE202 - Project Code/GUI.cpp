...
{	
	...
	if ( InterfaceMode == MODE_MENU )	
	{
		...
		{	
			...
			case ITM_enemy: return ADD_ENEMY;
				break;
				
			case ITM_obstacle: 
				
				return ADD_OBSTACLE; break;
				
			case ITM_cherry:
				
				return ADD_CHERRY; break;
				
			case ITM_life: 
				
				return ADD_LIFE; break;
				
			case ITM_enemyBuster: 
				
				return ADD_ENEMYBUSTER; break;
				
			case ITM_cheese: 
				
				return ADD_CHEESE; break;
				
			case ITM_empty: 
				
				return ADD_EMPTY; break;
...
//<<<<<<< HEAD
	...
	MenuItemImages[ITM_obstacle] = "images\\MenuItems\\obstacle.jpg";
	MenuItemImages[ITM_cherry] = "images\\MenuItems\\cherry.jpg";
	MenuItemImages[ITM_life] = "images\\MenuItems\\life.jpg";
	MenuItemImages[ITM_enemyBuster] = "images\\MenuItems\\enemyBuster.jpg";
	MenuItemImages[ITM_cheese] = "images\\MenuItems\\cheese.jpg";
	MenuItemImages[ITM_empty] = "images\\MenuItems\\erase.jpg";
//>>>>>>> //c221bca1d6a4874ce635adef0199f77d65c3786d
